...
COLORI_CORSO = {
    "ADAPTIVE LEARNING, ESTIMATION AND SUPERVISION OF DYNAMICAL SYSTEMS":           "#4F46E5",
    "ADVANCED DATA MANAGEMENT AND LABORATORY":                  "#0891B2",
    "STATISTICS FOR HIGH DIMENSIONAL DATA AND COMPSTAT LAB":          "#059669",
    "LINGUAGGI FORMALI E COMPILATORI":      "#7C3AED",
}
